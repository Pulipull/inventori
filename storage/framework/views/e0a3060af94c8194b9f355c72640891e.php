...
<div class="mb-4 grid gap-4 sm:grid-cols-2">
    <div class="rounded-lg bg-white p-4 shadow-sm">
        ...
        <p class="mt-2 text-2xl font-bold"><?php echo e($metrics['active_conversations']); ?></p>
    </div>
    <div class="rounded-lg bg-white p-4 shadow-sm">
        <p class="text-sm text-gray-500">Percakapan Belum Dibaca</p>
        <p class="mt-2 text-2xl font-bold"><?php echo e($metrics['unread_conversations']); ?></p>
    </div>
</div>
        ...
        <a href="<?php echo e(route('chat.show', $conversation)); ?>" class="rounded-lg bg-white p-4 shadow-sm hover:ring-2 hover:ring-moss/20">
            <div class="flex items-start justify-between gap-3">
                ...
                <?php if($conversation->unread_messages_count > 0): ?>
                    <span class="rounded bg-coral px-2 py-1 text-xs font-semibold text-white"><?php echo e($conversation->unread_messages_count); ?></span>
                <?php endif; ?>
            </div>
            <p class="mt-1 text-sm text-gray-500"><?php echo e($conversation->latestMessage?->body ?? 'Belum ada pesan.'); ?></p>
        </a>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\inventori\resources\views\chat\index.blade.php ENDPATH**/ ?>