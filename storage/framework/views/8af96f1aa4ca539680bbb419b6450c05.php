        ...
        <aside class="bg-ink text-white lg:min-h-screen lg:w-72">
            ...
            <nav class="grid gap-1 px-4 pb-6 text-sm">
                ...
                <?php $__currentLoopData = $links; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $link): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <?php if($link[1] === 'categories.index' && ! auth()->user()->isAdmin()) continue; ?>
                ...
                <form method="post" action="<?php echo e(route('logout')); ?>" class="mt-4">
                    <?php echo csrf_field(); ?>
                    <button class="w-full rounded bg-coral px-4 py-2 text-left font-semibold text-white">Keluar</button>
                </form>
            </nav>
        </aside>
