...
<div class="mt-6 grid gap-6 lg:grid-cols-2">
    <section class="rounded-lg bg-white p-5 shadow-sm">
        ...
        <div class="space-y-3">
            <?php $__currentLoopData = [['Lunas', $paidOrderCount, 'text-moss'], ['Pending', $pendingOrderCount, 'text-amber'], ['Gagal', $failedPaymentCount, 'text-coral'], ['Expired', $expiredPaymentCount, 'text-gray-500']]; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as [$label, $value, $color]): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <div class="flex justify-between border-b pb-3 text-sm">
                    <span><?php echo e($label); ?></span>
                    <strong class="<?php echo e($color); ?>"><?php echo e($value); ?></strong>
                </div>
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
        </div>
    </section>
    <section class="rounded-lg bg-white p-5 shadow-sm">
        ...
        <div class="space-y-3">
            <?php $__currentLoopData = $revenueTrend; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $trend): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <div class="flex justify-between border-b pb-3 text-sm">
                    <span><?php echo e($trend['date']); ?></span>
                    <strong class="text-moss">Rp <?php echo e(number_format($trend['total'], 0, ',', '.')); ?></strong>
                </div>
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
        </div>
    </section>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\inventori\resources\views\dashboard.blade.php ENDPATH**/ ?>