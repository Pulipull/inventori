...
<a href="<?php echo e(route('reports.sales.pdf', request()->only('date_from', 'date_to'))); ?>" class="rounded bg-coral px-4 py-2 text-sm font-semibold text-white">Export PDF</a>
...
<div class="mb-4 rounded-lg bg-white p-5 shadow-sm">
    ...
    <p class="mt-2 text-3xl font-bold">Rp <?php echo e(number_format($orders->sum('amount'), 0, ',', '.')); ?></p>
</div>
    ...
    <table class="w-full text-left text-sm">
        ...
        <?php $__empty_1 = true; $__currentLoopData = $orders; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $order): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
            <tr class="border-t">
                ...
                <td class="p-4"><?php echo e(strtoupper($order->payment_method ?? '-')); ?></td>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\inventori\resources\views\reports\sales.blade.php ENDPATH**/ ?>