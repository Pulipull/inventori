...
class DatabaseSeeder extends Seeder
{
    public function run(): void
    {
        ...
        $sampleItems = [
            ['Elektronik', 'BRG-EL-001', 'Router WiFi', 'unit', 12, 4],
            ['ATK', 'BRG-ATK-001', 'Kertas A4', 'rim', 30, 10],
            ['Kebersihan', 'BRG-KBR-001', 'Sabun Lantai', 'botol', 6, 8],
            ['Peralatan', 'BRG-PRL-001', 'Obeng Set', 'set', 0, 3],
        ];

        foreach ($sampleItems as [$categoryName, $code, $name, $unit, $stock, $minimum]) {
            Item::updateOrCreate(
                ['code' => $code],
                [
